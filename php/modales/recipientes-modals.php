                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-6">
                            <div class="mb-1">
                                ...
                                <select class="form-select" aria-label="Default select example" id="recipient-capacidad">
                        ...
                        <div class="col-12 col-sm-12 col-md-6">
                            <div class="mb-1">
                                <label for="recipient-tipo_material" class="col-form-label fw-bold">Tipo de
                                    material:</label>
                                <select class="form-select" aria-label="Default select example" id="recipient-tipo_material">
                                    <option selected value="0">Selección</option>
                                ...
                                <div class="input-group" id="section_otro_material">
                                    <input type="text" class="form-control" id="recipient-tipo_material_otro" placeholder="Escribe Aquí">
