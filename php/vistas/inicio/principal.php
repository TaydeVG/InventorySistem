...
<body>
    ...
    <div class="container-fluid animated zoomIn">
        <div class="row">
            <div class="col-3 ">
                <img class="rounded-circle img-rotate-infinit d-none d-sm-none d-md-block" src="../../../resources/imagenes/logo.png" alt="imagen" width="300" height="300">
                <img class="rounded-circle img-rotate-infinit d-block d-sm-block d-md-none" src="../../../resources/imagenes/logo.png" alt="imagen" width="100" height="100">
            </div>
            <div class="col-7 text-center">
                <br><br><br class=" d-none d-sm-none d-md-block"><br class=" d-none d-sm-none d-md-block"><br class=" d-none d-sm-none d-md-block">
