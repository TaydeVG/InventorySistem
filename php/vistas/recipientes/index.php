...
<head>
    ...
    <link rel="stylesheet" href="../../../css/recipientes.css">
...
<body style="background-color: #EEEEEE;">
    ...
    <?php include("../../modales/recipientes-modals.php"); ?>
                ...
                <div class="card text-center shadow animated fadeInLeft mb-3 mt-4">
                    <div class="card-header">
                        <div class="d-flex justify-content-between ">
                            <h3> Recipientes </h3>
                            <button class="btn btn-outline-success solo-admin" data-bs-toggle="modal" data-bs-target="#modalId" data-bs-opcion="new">Nuevo <i class="fas fa-plus"></i></button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript" src="../../../js/recipientes.js"></script>
</body>
